...
public class CrossedWires {
    ...
    static void traceWires(Port origin, List<String> wireTwistsAndTurns, String wireName) {
        ...
        while (e.hasMoreElements()) {
            ...
            currentPort = currentPort.tracePath(wireName, goingHere, stepsToTake);
        }
    }
